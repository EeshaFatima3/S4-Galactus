...
build_cmd = "./build.sh -a tests/test_sample4_softmax.s -l adapter.s -l milestone4/hilbert_vec.s -l milestone4/uproject_vec.s -l milestone4/gelu_vec.s -l milestone4/s4d_vec.s -l milestone4/takelast_vec.s -l milestone4/fc_vec.s -l math.s -l softmax.s -l weights.s"
os.system(build_cmd)

print("[*] Parsing Whisper Execution Log...")

log_path = "build/logs/test_sample4_softmax.txt"
